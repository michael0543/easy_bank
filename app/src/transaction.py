...
def gen_insert_deposit_sql(
    ...
    """Generate insert deposit sql into transaction table with \
        given account_id and amount
...
def gen_insert_withdraw_sql(
    ...
    """Generate insert withdraw sql into transaction table with \
        given account_id and amount
...
def gen_insert_transfer_sql(
    ...
    """Generate insert transfer sql into transaction table with \
        given account_id, amount and trans_type

    Args:
        - account_id: account_id
        - amount: transfer amount
        - trans_type: transaction type. include 'transaction_send' \
            and 'transaction_receive'
    """
    sqlstring = SQL(
        "INSERT INTO transaction(account_id, type, amount, timestamp) "
        "VALUES "
